...
;FindFloor:
sub_101BE:
		bsr.s	Floor_ChkTile;FindNearestTile
...
.isblank:
		add.w	a3,d2
		bsr.w	sub_10264;FindFloor2	; try tile below the nearest
		sub.w	a3,d2
...
.maxfloor:
		sub.w	a3,d2
		bsr.w	sub_10264;FindFloor2	; try tile above the nearest
		add.w	a3,d2
...
;FindFloor2:
sub_10264:
		bsr.w	Floor_ChkTile;FindNearestTile
		move.w	(a1),d0
		move.w	d0,d4
		andi.w	#$3FF,d0	; MJ: ($800/2)-1
		beq.s	.isblank2
