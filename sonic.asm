...
GetBlockData:
		...
		move.w	d4,d3
;		lsr.w	#1,d3
		andi.w	#$780,d3;andi.w	#$380,d3
		lsr.w	#3,d5
		move.w	d5,d0
		lsr.w	#4,d0;lsr.w	#5,d0
		andi.w	#$7F,d0
		lsl.w	#1,d3
		add.w	d3,d0
		moveq	#-1,d3
		move.b	(a4,d0.w),d3;same till here
